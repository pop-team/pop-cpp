...
int main(int argc, char** argv)
{
	...
	printf("Structparam1: Current object internal data = %d, %d\n",
		   o.GetData().GetMyData(),
	...
	b.SetInternalData(a);
	b.SetMyData(0);
	printf("Structparam1: Current b internal data = %d, %d\n",
	...
	if ((v==20) &&
		...
		printf("Structparam1: test succeeded, destroying objects...\n");
	else
		printf("Structparam1: Test failed, bad value transmission\n");
