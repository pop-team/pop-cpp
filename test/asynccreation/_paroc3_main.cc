...
{
 try {
  rprintf("Asynchronous allocation of parallel object\n");
  rprintf("Before creating POPObject o1\n");
  POPObject o1;
  rprintf("Before creating POPObject o2\n");
  POPObject o2;
  rprintf("Before creating POPObject o3\n");
  POPObject o3;
  rprintf("Before calling method 1 on POPObject o1\n");
  o1.firstMethod();
  rprintf("Before calling method 1 on POPObject o2\n");
  o2.firstMethod();
  rprintf("Before calling method 1 on POPObject o3\n");
  o3.firstMethod();
  rprintf("Before calling method 2 on POPObject o1\n");
  o1.secondMethod();
  rprintf("Before calling method 2 on POPObject o2\n");
  o2.secondMethod();
  rprintf("Before calling method 2 on POPObject o3\n");
  o3.secondMethod();
