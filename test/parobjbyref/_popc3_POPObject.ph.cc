...
void POPObject::voidMethod(POPObject &o)
{
  ...
  paroc_connection* _popc_connection = __paroc_combox->get_connection();
  __paroc_buf->Reset();
  paroc_message_header __paroc_buf_header(CLASSUID_POPObject,12,1, "voidMethod");
  __paroc_buf->SetHeader(__paroc_buf_header);
(*__paroc_buf).Push("o","paroc_interface",1);
((POPObject &)(o)).Serialize((*__paroc_buf), true);(*__paroc_buf).Pop();
  ...
  popc_send_request(__paroc_buf, _popc_connection);	{
	...
	paroc_buffer::CheckAndThrow(*__paroc_buf);
(*__paroc_buf).Push("o","paroc_interface",1);
((POPObject &)(o)).Serialize((*__paroc_buf), false);(*__paroc_buf).Pop();
    ...
    switch(method[1])
{
    ...
    case 12: Invoke_voidMethod_12(__brokerbuf, peer); return true;
    default:
      return false;
    }
  }
...
{
static paroc_method_info _paroc_minfo[2]={{10,(char*)"POPObject"},{12,(char*)"voidMethod"}};
AddMethodInfo(CLASSUID_POPObject, _paroc_minfo, 2);
}
...
void POPObject_popcobject_Broker::Invoke_voidMethod_12(paroc_buffer &__paroc_buf, paroc_connection *__interface_output)
{
  POPObject o(paroc_interface::_paroc_nobind);
__paroc_buf.Push("o","paroc_interface",1);
((POPObject &)(o)).Serialize(__paroc_buf, false);__paroc_buf.Pop();

POPObject_popcobject * _paroc_obj = dynamic_cast<POPObject_popcobject *>(obj);
try {
_paroc_obj->voidMethod(o);
  } catch(std::exception& e) {
    printf("POP-C++ Warning: Exception '%s' raised in method 'voidMethod' of class 'POPObject'\n",e.what());
    throw;
  }
...
{
__paroc_buf.Reset();
paroc_message_header __paroc_buf_header("voidMethod");
__paroc_buf.SetHeader(__paroc_buf_header);
__paroc_buf.Push("o","paroc_interface",1);
((POPObject &)(o)).Serialize(__paroc_buf, true);__paroc_buf.Pop();
