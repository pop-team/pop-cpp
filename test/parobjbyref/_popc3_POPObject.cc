...
# 2 "POPObject.cc" 2
# 10 "POPObject.cc"
POPObject_popcobject::POPObject_popcobject()
{__POPThis_POPObject=new POPObject(GetAccessPointForThis());
   paroc_system::_popc_cout.str(""); paroc_system::_popc_cout << "POPCobject created (by JobMgr) on machine:" << GetAccessPoint().GetAccessString() << std::endl; rprintf(paroc_system::_popc_cout.str().c_str());
}
...
void POPObject_popcobject::voidMethod(POPObject& o){
 paroc_system::_popc_cout.str(""); paroc_system::_popc_cout << "Method with void param is called" << std::endl; rprintf(paroc_system::_popc_cout.str().c_str());
}
...
void paroc_registerbroker() {
  POPObject_popcobject_Broker::_popc_factory.test("POPObject");
}
