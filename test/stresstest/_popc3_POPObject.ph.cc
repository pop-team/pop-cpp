...
void Invoke_getCounter_12(paroc_buffer &__paroc_buf, paroc_connection *__interface_output);
void Invoke_increment_13(paroc_buffer &__paroc_buf, paroc_connection *__interface_output);
public:
...
int POPObject::getCounter()
{
  ...
  paroc_connection* _popc_connection = __paroc_combox->get_connection();
  __paroc_buf->Reset();
  paroc_message_header __paroc_buf_header(CLASSUID_POPObject,12,1, "getCounter");
  __paroc_buf->SetHeader(__paroc_buf_header);
  ...
  popc_send_request(__paroc_buf, _popc_connection);	{
	...
	paroc_buffer::CheckAndThrow(*__paroc_buf);
int _RemoteRet;
(*__paroc_buf).Push("_RemoteRet","int", 1);
(*__paroc_buf).UnPack(&_RemoteRet,1);
(*__paroc_buf).Pop();
...
void POPObject::increment()
{
  ...
  paroc_connection* _popc_connection = __paroc_combox->get_connection();
  __paroc_buf->Reset();
  paroc_message_header __paroc_buf_header(CLASSUID_POPObject,13,0, "increment");
  __paroc_buf->SetHeader(__paroc_buf_header);

  popc_send_request(__paroc_buf, _popc_connection);
  __paroc_buf->Reset();_popc_connection->reset();
}

# 22 "POPObject.ph"

# 31020 "_popc3_POPObject.ph.cc"

bool POPObject_popcobject_Broker::Invoke(unsigned method[3], paroc_buffer &__brokerbuf, paroc_connection *peer)
{
 if (*method==CLASSUID_POPObject) {
    switch(method[1])
{
    case 10: Invoke_POPObject_10(__brokerbuf, peer); return true;
    case 12: Invoke_getCounter_12(__brokerbuf, peer); return true;
    case 13: Invoke_increment_13(__brokerbuf, peer); return true;
    default:
      return false;
    }
  }
...
POPObject_popcobject_Broker::POPObject_popcobject_Broker()
{
static paroc_method_info _paroc_minfo[3]={{10,(char*)"POPObject"},{12,(char*)"getCounter"},{13,(char*)"increment"}};
AddMethodInfo(CLASSUID_POPObject, _paroc_minfo, 3);
}
void POPObject_popcobject_Broker::Invoke_POPObject_10(paroc_buffer &__paroc_buf, paroc_connection *__interface_output)
{
  
  try {
    obj = new POPObject_popcobject();
  } catch(std::exception& e) {
    printf("POP-C++ Warning: Exception '%s' raised in method 'POPObject' of class 'POPObject'\n",e.what());
    throw;
  }
...
void POPObject_popcobject_Broker::Invoke_getCounter_12(paroc_buffer &__paroc_buf, paroc_connection *__interface_output)
{
  
int _RemoteRet;
POPObject_popcobject * _paroc_obj=dynamic_cast<POPObject_popcobject *>(obj);
try {
_RemoteRet=_paroc_obj->getCounter();
  } catch(std::exception& e) {
    printf("POP-C++ Warning: Exception '%s' raised in method 'getCounter' of class 'POPObject'\n",e.what());
    throw;
  }
...
{
__paroc_buf.Reset();
paroc_message_header __paroc_buf_header("getCounter");
__paroc_buf.SetHeader(__paroc_buf_header);
__paroc_buf.Push("_RemoteRet","int", 1);
...
void POPObject_popcobject_Broker::Invoke_increment_13(paroc_buffer &__paroc_buf, paroc_connection *__interface_output)
{
  
POPObject_popcobject * _paroc_obj = dynamic_cast<POPObject_popcobject *>(obj);
try {
_paroc_obj->increment();
  } catch(std::exception& e) {
    printf("POP-C++ Warning: Exception '%s' raised in method 'increment' of class 'POPObject'\n",e.what());
    throw;
  }
...
{
__paroc_buf.Reset();
paroc_message_header __paroc_buf_header("increment");
__paroc_buf.SetHeader(__paroc_buf_header);
...
paroc_broker *POPObject_popcobject_Broker::_init() { return new POPObject_popcobject_Broker; }
paroc_broker_factory POPObject_popcobject_Broker::_popc_factory(_init, "POPObject");
