#ifndef PAROC_BUFFER_XDR_ZLIB_FACTORY_H
#define PAROC_BUFFER_XDR_ZLIB_FACTORY_H

#include "paroc_buffer_factory.h"

/*This abstract class declares an interface creating abstract combox*/
class paroc_buffer_xdr_zlib_factory:public paroc_buffer_factory{
public:

  paroc_buffer_xdr_zlib_factory();
