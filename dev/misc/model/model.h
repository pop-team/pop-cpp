...
+ InitProblem(input,  output) to return the "real" problem object (derived from class ProbObj). In this method, the user
should also implement the initialization of the created problem object. This method should return NULL if problem cannot
be solved (out of resource)


- Class ProbObj describes how the problem is really solved (parallel object). The user should implement Solve method to
really solve its represented problem. All input, output data necessarry are prior set in DTreeNode::InitProblem method.
