 ...
 */
JobMgr::JobMgr(bool daemon, const std::string &conf, const std::string &challenge, const std::string &url, const pop_accesspoint &nodeAccess,  const pop_accesspoint &localPSM): JobCoreService(challenge) {
    //Added by clementval
