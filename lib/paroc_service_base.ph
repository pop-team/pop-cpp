...
public:
	...
	*/
	sync conc virtual int CreateObject(const paroc_accesspoint &localservice, const paroc_string &objname, const paroc_od &od, int howmany, [out,size=howmany] paroc_accesspoint *objcontacts)=0;
