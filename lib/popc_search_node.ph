...
protected:	
   ...
   POPSynchronizer knownRequestLock;  						// sync. for actual req.
   POPSynchronizer checkResourceLock;						// lock for checking the resource
	POPSynchronizer logicalClockLock;
	POPSynchronizer logicalCounterLock;
