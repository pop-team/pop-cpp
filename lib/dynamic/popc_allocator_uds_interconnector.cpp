 ...
 */
std::string uds_allocator_interconnector::allocate(std::string& objectname, pop_od& od) {
 ...
 */
pop_combox* uds_allocator_interconnector::allocate_group(std::string& objectname, pop_od& od, int nb) {
