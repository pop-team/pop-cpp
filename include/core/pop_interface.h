...
public:
    ...
    */
    ...
    static int LocalExec(const char* hostname, const char* codefile, const char* classname,
                         const pop_accesspoint& jobservice, const pop_accesspoint& appservice,
     ...
     * Thread used for asynchronous allocation of the parallel object. Do not change its name as it is used in the
     * POP-C++ parser
     * to generate code.
     */
